...
#if                             PreScaler_Mode==DIVIDED_BY_2
	/*set PreScaler /2  */
...
#elif                           PreScaler_Mode==DIVIDED_BY_4
	/*set PreScaler /4  */
	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS2 );
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS1 );
	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS0 );

#elif                           PreScaler_Mode==DIVIDED_BY_16
	/*set PreScaler /16 */
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS2 );
	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS1 );
	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS0 );

#elif                           PreScaler_Mode==DIVIDED_BY_32
	/*set PreScaler /32 */
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS2 );
  	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS1 );
  	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS0 );

#elif                           PreScaler_Mode==DIVIDED_BY_64
	/*set PreScaler /64 */
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS2 );
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS1 );
	CLR_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS0 );

#elif                           PreScaler_Mode==DIVIDED_BY_128
	/*set PreScaler /128 */
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS2 );
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS1 );
	SET_BIT ( ADC_U8_ADCSRA_REG , ADC_ADCSRA_ADPS0 );
